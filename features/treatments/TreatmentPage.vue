...
import RelatedTreatments from './components/RelatedTreatments.vue'
import TreatmentNotFound from './components/TreatmentNotFound.vue'
...
const breadcrumbs = computed(() => [
  ...
  { path: `/behandelingen/${props.treatment?.slug || ''}`, label: props.treatment?.title || 'Behandeling', icon: 'i-mdi-sparkles' }
])
</script>
