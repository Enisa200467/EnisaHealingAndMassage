...
const pendingReviews = ref([
  {
    id: 1,
    client: 'Maria K.',
    treatment: 'Energetische Healing',
    rating: 5,
    content: 'Geweldige ervaring, zeer ontspannend...',
  },
  {
    id: 2,
    client: 'Peter J.',
    treatment: 'Klassieke Massage',
    rating: 4,
    content: 'Goed geholpen, professioneel...',
  },
]);
</script>
        ...
        <table class="w-full">
          <thead>
            <tr class="border-b border-neutral-200">
              <th class="text-left py-3 text-sm font-medium text-neutral-600">
                Klant
              </th>
              <th class="text-left py-3 text-sm font-medium text-neutral-600">
                Behandeling
          ...
          <tbody>
            ...
            >
              <td class="py-3 text-sm text-neutral-900">
                {{ booking.client }}
              </td>
