...
<template>
  <div class="space-y-4">
    ...
    <div v-if="!selectedDate" class="text-center py-8">
      <UIcon name="i-mdi-calendar" class="w-12 h-12 text-neutral-400 mx-auto mb-3" />
      <p class="text-neutral-500">Selecteer eerst een datum om beschikbare tijden te zien</p>
    </div>
      ...
      <div class="flex items-start gap-3">
        ...
        <div class="text-sm">
          ...
          <p class="text-blue-700 mt-1">
            Klik op een beschikbaar tijdslot om je afspraak in te plannen. 
