        ...
        <section class="mb-16">
          ...
          <div class="prose prose-lg max-w-3xl mx-auto">
            <p class="text-neutral-600 leading-relaxed mb-6">
              Mijn reis in de wereld van healing en massage begon meer dan 10
              jaar geleden. Na een succesvolle carrière in de zakelijke wereld,
              voelde ik een sterke roeping om mensen te helpen bij hun fysieke
            ...
            <p class="text-neutral-600 leading-relaxed mb-6">
              ...
              besloot mijn carrière om te gooien en me volledig te wijden aan
              het helpen van anderen op hun pad naar genezing en balans.
            </p>
            <p class="text-neutral-600 leading-relaxed">
              ...
              bieden. Elke sessie is op maat gemaakt voor de individuele
              behoeften van mijn cliënten.
            </p>
          </div>
        </section>
            ...
            <UCard>
              ...
              <ul class="space-y-3">
                ...
                <li class="flex items-start gap-3">
                  ...
                  />
                  <span class="text-neutral-600"
                    >Chakra Healing Specialist</span
                  >
                </li>
                <li class="flex items-start gap-3">
                  <UIcon
          ...
          <UCard class="bg-gradient-to-br from-primary-50 to-secondary-50">
            <div class="text-center">
              ...
              <blockquote class="text-xl italic text-neutral-700 mb-6">
                "Echte genezing gebeurt wanneer lichaam, geest en ziel in
                harmonie zijn. Mijn missie is om mensen te begeleiden op hun
                unieke reis naar balans en welzijn."
              </blockquote>
              <div class="prose max-w-none">
                <p class="text-neutral-600 leading-relaxed">
                  ...
                  waar transformatie kan plaatsvinden. Door intuïtie, ervaring
                  en bewezen technieken te combineren, help ik mijn cliënten om
                  hun innerlijke kracht te herontdekken.
                </p>
              </div>
            </div>
          </UCard>
