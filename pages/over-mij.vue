          ...
          <section class="mb-16">
            ...
            <div class="prose prose-lg max-w-3xl mx-auto">
              <p class="text-neutral-600 leading-relaxed mb-6">
                ...
                jaar geleden. Na een succesvolle carrière in de zakelijke
                wereld, voelde ik een sterke roeping om mensen te helpen bij hun
                fysieke en emotionele welzijn.
              </p>
              <p class="text-neutral-600 leading-relaxed mb-6">
                Wat begon als persoonlijke interesse in holistische gezondheid,
                groeide uit tot een passie die mijn leven volledig veranderde.
                Ik besloot mijn carrière om te gooien en me volledig te wijden
                aan het helpen van anderen op hun pad naar genezing en balans.
              </p>
              <p class="text-neutral-600 leading-relaxed">
                Vandaag de dag combineer ik traditionele massagetechnieken met
                energetische healing om een unieke en transformerende ervaring
                te bieden. Elke sessie is op maat gemaakt voor de individuele
              ...
              <div class="text-center">
                ...
                <div class="prose max-w-none">
                  <p class="text-neutral-600 leading-relaxed">
                    ...
                    en bewezen technieken te combineren, help ik mijn cliënten
                    om hun innerlijke kracht te herontdekken.
                  </p>
                </div>
              </div>
            </UCard>
