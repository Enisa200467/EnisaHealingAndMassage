        ...
        <div>
          <div class="space-y-4">
            <UCard>
              <template #header>
                <div class="flex items-center gap-2">
                  <UIcon name="i-mdi-car" class="w-5 h-5 text-primary-500" />
            ...
            <UCard>
              ...
              <p class="text-neutral-600 text-sm">
                <span class="font-medium text-neutral-700">Veerboot:</span><br><br>
                ...
                <span class="font-medium text-neutral-700">Met metro en bus (vanuit Amsterdam of Amsterdam Centraal):</span><br>
                Neem metro 52 (Noord/Zuidlijn) en stap uit bij station Noord.<br>
            ...
            <UCard>
              ...
              <p class="text-neutral-600 text-sm">
                Fietsenstalling beschikbaar achter het pand. Goed bereikbaar via
                de grote fietspaden.
              </p>
            </UCard>
          </div>
